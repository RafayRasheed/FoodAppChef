...
export const OrderDetails = ({ navigation, route }) => {
    ...
    function onUpdate(status, statusT) {
        // setIsLoading(true)
        // -1=rejected
        // -2=cancelled
        // 100= completed
        ...
        <>
            ...
            <SafeAreaView style={{
                ...
                <View style={{ paddingHorizontal: myWidth(4) }}>
                    ...
                    {
                        item.status == 0 &&
                        <TouchableOpacity activeOpacity={0.9} onPress={() => onUpdate(1, 'In Progress')}
                            style={{
                    ...
                    {
                        item.status == 0 &&
                        <TouchableOpacity activeOpacity={0.9} onPress={() => onUpdate(-1, 'Rejected')}
                            style={{
                    ...
                    {
                        item.status == 1 &&
                        <TouchableOpacity activeOpacity={0.9} onPress={() => onUpdate(100, 'Completed')}
                            style={{
                                backgroundColor: myColors.primaryT,
                                borderRadius: myHeight(0.8),
                                paddingVertical: myHeight(1.1),
