...
const dummy = [
  {
    ...
    name: 'Side Item',
    list: [
      'Med Fries [350.0 Cals]',
      'Med Fries [30.0 Cals]',
      'Med Fries [50.0 Cals]',
      'Med Fries [300.0 Cals]',
    ],
  },
  {
    required: false,
...
export const ItemEdit = ({navigation, route}) => {
  ...
  const [selectCat, setSelectCat] = useState(
    item.catName ? item.catName : null,
  );
  const [selectSubCat, setSelectSubCat] = useState(
    item.subCatName ? item.subCatName : null,
  );
  ...
  const [subCategories, setSubCategories] = useState(
    profile.subCategories ? profile.subCategories : [],
  );
      ...
      <View>
        ...
        <View
          ...
          <TouchableOpacity
            ...
            style={{paddingHorizontal: myWidth(4)}}>
            <Image
              style={{
                height: myHeight(2.4),
                width: myHeight(2.4),
      ...
      <KeyboardAwareScrollView
        ...
        <View style={{marginStart: -myWidth(4), width: myWidth(100)}}>
          ...
          <ScrollView
            ...
            {categories?.map((item, i) => (
              <View
                key={i}
                style={{paddingBottom: myHeight(1), paddingEnd: myWidth(5)}}>
                <TouchableOpacity
                  activeOpacity={0.8}
                  style={{
                    flexDirection: 'row',
            ...
            <TouchableOpacity
              ...
              <Image
                style={{
                  ...
                  transform: [{rotate: addCategory ? '-90deg' : '90deg'}],
                }}
          ...
          <Collapsible collapsed={!addCategory}>
            ...
            <View
              ...
              <TouchableOpacity
                ...
                onPress={onAddNewCat}
                style={{
                  paddingVertical: myHeight(0.9),
                  marginVertical: myHeight(0.2),
          ...
          <View>
            ...
            {subCategories?.length ? (
              ...
              <Text
                ...
                No Sub Category Found Click On Add
              </Text>
            )}
          </View>
        </View>
        ...
        {profile.homeDelivery ? (
          <View>
            <View
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.6}
                onPress={() => setAddOption(!addOption)}>
                <Text
                  style={[
                    styles.textCommon,
                    {
                ...
                <Image
                  style={{
                    ...
                    resizeMode: 'contain',
                    tintColor: myColors.primaryT,
                    transform: [{rotate: addOption ? '-90deg' : '90deg'}],
                  }}
                  source={require('../assets/home_main/home/go.png')}
                />
              </TouchableOpacity>
                ...
                <View
                  ...
                  <Text
                    ...
                    <Text
                      ...
                      {'(User Must Select Before Place Order)'}
                    </Text>
                  </Text>
                </View>
              </TouchableOpacity>
          ...
          <Text
            ...
            Item Options Hidden Because Home Delivery Not Available In Your
            Restaurant
          </Text>
        )}
